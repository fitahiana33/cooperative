...
export interface User { id: number; name: string; first_name?: string; email: string; telephone?: string; address?: string; role: string; roles: UserRole[]; permissions?: string[]; is_active: boolean; created_at: string }
